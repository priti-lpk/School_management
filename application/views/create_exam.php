                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Add_exam/edit_exam/' . $users[0]['id']) : site_url('Add_exam/insert_exam'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Exam Name</label>
                                                    <div class="col-sm-9" style="margin-left: -95px;">
                                                        <input class="form-control" type="text"  placeholder="Exam Name" id="exam_name" name="exam_name" value="<?php echo isset($users) ? set_value("exam_name", $users[0]['exam_name']) : set_value(""); ?>" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10" style="margin-left: -95px;">
                                                        <textarea id="elm1" name="note"><?php echo (isset($users) ? $users[0]['note'] : ''); ?></textarea>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View of Exam</h4><br>
                                                    ...
                                                    if (!empty($all)) {
                                                        ...
                                                        foreach ($all as $e) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url() . 'Add_exam/getdata_exam/' . $e['id'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Add_exam/delete_exam/' . $e['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
