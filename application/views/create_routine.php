                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Add_routine/edit_routine/' . $users[0]['id']) : site_url('Add_routine/insert_routine'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                    ...
                                                    if (!empty($all)) {
                                                        ...
                                                        foreach ($all as $a) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url() . 'Add_routine/getdata_routine/' . $a['iid'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Add_routine/delete_routine/' . $a['iid'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
