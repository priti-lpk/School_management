                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View Teacher Details</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View of Teacher Details</h4><br>
                                                    ...
                                                    if (!empty($all)) {
                                                        ...
                                                        foreach ($all as $a) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $a['t_mobno'] ?></td>
                                                                <td><?php echo $a['address'] ?></td>
                                                                <td><?php echo $a['joining_date'] ?></td>
                                                                <td><img src="<?php echo base_url("Teacher/" . $a['t_image']); ?>" height="60" width="60"></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
