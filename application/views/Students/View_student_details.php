                                            ...
                                            <table class="table mb-0">
                                                ...
                                                if (!empty($all)) {
                                                    foreach ($all as $a) {
                                                        ?>
                                                        <tr>
                                                            <td colpan="2" style="display: inline-block; text-align: centers"><img src="<?php echo base_url("Student/" . $a['s_image']); ?>" height="100" width="100">
                                                        </tr>
                                                        <tr>
                                                            <td><b>G. R. No.: </b><?php echo $a['s_grno'] ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Student Name: </b><?php echo $a['s_surname'] . " " . $a['s_name'] . " " . $a['s_fathername'] ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Date of Birth: </b><?php echo $a['s_dob'] ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Address: </b><?php echo $a['s_address'] ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
