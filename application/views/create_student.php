                                            ...
                                            <form action="<?php echo isset($users) ? site_url('Add_student/edit_student/' . $users['id']) : site_url('Add_student/insert_student'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4" id="partylist5">
                                                        <select class="form-control select2" name="party_id" id="create_party"  onchange="partychange();" >
                                                            <option>Select Party</option>
                                                            <?php
                                                            foreach ($party as $p) {
                                                                if (isset($users)) {
                                                                    ?>
                                                                    <option <?php echo ($p->id == $users[0]['party_id'] ? 'selected' : '') ?> value="<?php echo $p->id; ?>" disabled=""><?php echo $p->party_name; ?></option>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <option value="<?php echo $p->id; ?>" ><?php echo $p->party_name; ?></option>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
