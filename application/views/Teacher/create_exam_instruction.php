                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Create Exam Instruction</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Teacher/Add_exam_instruction/edit_exam_instruction/' . $users[0]['id']) : site_url('Teacher/Add_exam_instruction/insert_exam_instruction'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10" style="margin-left: -80px;">
                                                        <textarea id="elm1" name="content"><?php echo (isset($users) ? $users[0]['content'] : ''); ?></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    if (!empty($class)) {
                                                        ...
                                                        foreach ($class as $c) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url() . 'Teacher/Add_exam_instruction/getdata_exam_instruction/' . $c['id'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Teacher/Add_exam_instruction/delete_exam_instruction/' . $c['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
