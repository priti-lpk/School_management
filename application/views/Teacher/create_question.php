    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Teacher/Add_question/edit_question/' . $users[0]['id']) : site_url('Teacher/Add_question/insert_question'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                    ...
                                                    if (!empty($all)) {
                                                        ...
                                                        foreach ($all as $a) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url() . 'Teacher/Add_question/getdata_question/' . $a['iid'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Teacher/Add_question/delete_question/' . $a['iid'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
        ...
        <script type="text/javascript">
                                                                function mainchange() {
                                                                    ...
                                                                    $.ajax({
                                                                        url: "<?php echo base_url() . 'Teacher/Add_question/get_class' ?>",
                                                                        method: "POST",
                                                                        datatype: "html",
                                                                        data: dataString,
                                                                        cache: false,
