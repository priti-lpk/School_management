                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Add_event/edit_event/' . $users[0]['id']) : site_url('Add_event/insert_event'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4"style="margin-left: -95px;">
                                                        <input class="form-control" type="text"  placeholder="Date" id="date" name="date" value="<?php echo isset($users) ? set_value("date", $users[0]['date']) : set_value(""); ?>" required="">
                                                    </div>
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Photo</label>
                                                    <div class="col-sm-4" style="margin-left: -80px;">
                                                        <input type="file" id="photo" name="photo" class="form-control filestyle" data-input="false" data-buttonname="btn-secondary" value="<?php echo isset($users) ? set_value("photo", $users[0]['photo']) : set_value(""); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View of Event</h4><br>
                                                    ...
                                                    if (!empty($all)) {
                                                        ...
                                                        foreach ($all as $e) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><img src="<?php echo base_url("Event/" . $e['photo']); ?>" height="60" width="60"></td>
                                                                <td><?php echo $e['details'] ?></td>
                                                                <td><a href="<?php echo base_url() . 'Add_event/getdata_event/' . $e['id'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Add_event/delete_event/' . $e['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
