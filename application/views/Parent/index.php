            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0">
                        <a href="index.php" class="logo logo-admin"><img src="" height="80" alt="logo"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-muted font-18 m-b-5 text-center">Welcome Back !</h4>
                        <p class="text-muted text-center">Sign in to continue to School Management(Parents)</p>

                        <form class="form-horizontal m-t-30" action="<?php echo base_url('Parent/Index/verifyUser') ?>" method="post">
