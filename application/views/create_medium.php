                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Create Medium</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="<?php echo isset($users) ? site_url('Add_medium/edit_medium/' . $users[0]['id']) : site_url('Add_medium/insert_medium'); ?>" id="form_data" name="party" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Medium Name</label>
                                                    <div class="col-sm-4" style="margin-left: -80px;">
                                                        <input class="form-control" type="text"  placeholder="Medium Name" id="medium_name" name="medium_name" value="<?php echo isset($users) ? set_value("medium_name", $users[0]['medium_name']) : set_value(""); ?>" required="">
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View of Medium</h4><br>
                                                    ...
                                                    if (!empty($class)) {
                                                        ...
                                                        foreach ($class as $c) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url() . 'Add_medium/getdata_medium/' . $c['id'] ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
                                                                    <a href="<?php echo base_url() . 'Add_medium/delete_medium/' . $c['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
                                                            </tr>   
                                                            <?php
                                                        }
                                                    }
